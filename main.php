...
<body class="mt-5 pt-4">
    ...
    <div id="Member" class="member animate">
        <form class="member-content" method="post" enctype="multipart/form-data">
            <div class="container m-2">
                <img class="mb-2" src="photo.php" alt="頭貼" style="width: 80px; height: 80px; border: 2px solid #888; border-radius: 50%; object-fit: contain;">
                <h3>嗨！<?=$user['name'] ?></h3>
            </div>
